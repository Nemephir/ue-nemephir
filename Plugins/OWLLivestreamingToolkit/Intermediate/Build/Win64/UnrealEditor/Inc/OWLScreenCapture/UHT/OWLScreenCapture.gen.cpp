...
// End Cross Module References
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOWLScreenCapture_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AOWLScreenCapture_GetAvailableMonitorNames, "GetAvailableMonitorNames" }, // 2512659904
		{ &Z_Construct_UFunction_AOWLScreenCapture_GetAvailableWindowNames, "GetAvailableWindowNames" }, // 1712998949
		{ &Z_Construct_UFunction_AOWLScreenCapture_SetMonitor, "SetMonitor" }, // 4142449912
		{ &Z_Construct_UFunction_AOWLScreenCapture_SetWindow, "SetWindow" }, // 3436381467
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AOWLScreenCapture_Statics::FuncInfo) < 2048);
#if WITH_METADATA
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapture_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOWLScreenCapture, AOWLScreenCapture::StaticClass, TEXT("AOWLScreenCapture"), &Z_Registration_Info_UClass_AOWLScreenCapture, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOWLScreenCapture), 1330143716U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLScreenCapture_Public_OWLScreenCapture_h_329377091(TEXT("/Script/OWLScreenCapture"),
