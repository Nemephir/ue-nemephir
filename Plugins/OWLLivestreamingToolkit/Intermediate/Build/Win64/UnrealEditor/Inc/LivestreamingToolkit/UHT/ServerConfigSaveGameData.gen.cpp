...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkippedPluginVersionHash = { "SkippedPluginVersionHash", nullptr, (EPropertyFlags)0x0010000000020015, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FPluginUpdateSaveGameData, SkippedPluginVersionHash), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkippedPluginVersionHash_MetaData), Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewProp_SkippedPluginVersionHash_MetaData) };
...
template<> LIVESTREAMINGTOOLKIT_API UScriptStruct* StaticStruct<FPluginSettingsSaveGameData>()
{
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_Statics::ScriptStructInfo[] = {
		{ FPluginUpdateSaveGameData::StaticStruct, Z_Construct_UScriptStruct_FPluginUpdateSaveGameData_Statics::NewStructOps, TEXT("PluginUpdateSaveGameData"), &Z_Registration_Info_UScriptStruct_PluginUpdateSaveGameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPluginUpdateSaveGameData), 2555173608U) },
		{ FPluginSettingsSaveGameData::StaticStruct, Z_Construct_UScriptStruct_FPluginSettingsSaveGameData_Statics::NewStructOps, TEXT("PluginSettingsSaveGameData"), &Z_Registration_Info_UScriptStruct_PluginSettingsSaveGameData, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPluginSettingsSaveGameData), 380896712U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_ServerConfigSaveGameData_h_2223524016(TEXT("/Script/LivestreamingToolkit"),
		nullptr, 0,
