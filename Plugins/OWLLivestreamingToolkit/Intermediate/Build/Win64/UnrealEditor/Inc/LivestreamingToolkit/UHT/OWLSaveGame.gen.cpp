...
// End Cross Module References
...
#endif
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_UserIndex = { "UserIndex", nullptr, (EPropertyFlags)0x0010000000020001, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLSaveGame, UserIndex), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_UserIndex_MetaData), Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_UserIndex_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveFileName = { "PluginSettingsSaveFileName", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLSaveGame, PluginSettingsSaveFileName), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveFileName_MetaData), Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveFileName_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveGameData = { "PluginSettingsSaveGameData", nullptr, (EPropertyFlags)0x0010000000000000, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(UOWLSaveGame, PluginSettingsSaveGameData), Z_Construct_UScriptStruct_FPluginSettingsSaveGameData, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveGameData_MetaData), Z_Construct_UClass_UOWLSaveGame_Statics::NewProp_PluginSettingsSaveGameData_MetaData) }; // 380896712
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UOWLSaveGame, UOWLSaveGame::StaticClass, TEXT("UOWLSaveGame"), &Z_Registration_Info_UClass_UOWLSaveGame, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UOWLSaveGame), 1933094903U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_LivestreamingToolkit_Private_SaveGameData_OWLSaveGame_h_917514828(TEXT("/Script/LivestreamingToolkit"),
