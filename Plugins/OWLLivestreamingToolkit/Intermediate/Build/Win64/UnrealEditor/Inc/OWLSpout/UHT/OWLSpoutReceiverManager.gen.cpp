...
template<> OWLSPOUT_API UScriptStruct* StaticStruct<FOWLSpoutReceiverInterface>()
{
...
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_bUpgrade8bitTo16_MetaData[];
#endif
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_UseFirstAvailableSender = { "UseFirstAvailableSender", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLSpoutReceiverInterface), &Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_UseFirstAvailableSender_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_UseFirstAvailableSender_MetaData), Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_UseFirstAvailableSender_MetaData) };
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSpoutReceiverInterface, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bFixGamma = { "bFixGamma", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLSpoutReceiverInterface), &Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bFixGamma_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bFixGamma_MetaData), Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bFixGamma_MetaData) };
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bUpgrade8bitTo16_MetaData[] = {
		{ "Category", "OWLSpoutReceiver" },
	...
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bUpgrade8bitTo16 = { "bUpgrade8bitTo16", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, sizeof(bool), sizeof(FOWLSpoutReceiverInterface), &Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bUpgrade8bitTo16_SetBit, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bUpgrade8bitTo16_MetaData), Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewProp_bUpgrade8bitTo16_MetaData) };
#if WITH_METADATA
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOWLSpoutReceiverManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AOWLSpoutReceiverManager_GetAvailableSenderNames, "GetAvailableSenderNames" }, // 2841669268
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AOWLSpoutReceiverManager_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOWLSpoutReceiverManager_Statics::NewProp_SpoutReceivers = { "SpoutReceivers", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AOWLSpoutReceiverManager, SpoutReceivers), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AOWLSpoutReceiverManager_Statics::NewProp_SpoutReceivers_MetaData), Z_Construct_UClass_AOWLSpoutReceiverManager_Statics::NewProp_SpoutReceivers_MetaData) }; // 2465907611
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLSpout_Public_OWLSpoutReceiverManager_h_Statics::ScriptStructInfo[] = {
		{ FOWLSpoutReceiverInterface::StaticStruct, Z_Construct_UScriptStruct_FOWLSpoutReceiverInterface_Statics::NewStructOps, TEXT("OWLSpoutReceiverInterface"), &Z_Registration_Info_UScriptStruct_OWLSpoutReceiverInterface, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLSpoutReceiverInterface), 2465907611U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLSpout_Public_OWLSpoutReceiverManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOWLSpoutReceiverManager, AOWLSpoutReceiverManager::StaticClass, TEXT("AOWLSpoutReceiverManager"), &Z_Registration_Info_UClass_AOWLSpoutReceiverManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOWLSpoutReceiverManager), 3006837832U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLSpout_Public_OWLSpoutReceiverManager_h_542304809(TEXT("/Script/OWLSpout"),
