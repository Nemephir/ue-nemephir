...
template<> OWLSPOUT_API UScriptStruct* StaticStruct<FOWLSpoutSenderInterface>()
{
...
#endif
	const UECodeGen_Private::FStrPropertyParams Z_Construct_UScriptStruct_FOWLSpoutSenderInterface_Statics::NewProp_Name = { "Name", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Str, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(FOWLSpoutSenderInterface, Name), METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UScriptStruct_FOWLSpoutSenderInterface_Statics::NewProp_Name_MetaData), Z_Construct_UScriptStruct_FOWLSpoutSenderInterface_Statics::NewProp_Name_MetaData) };
#if WITH_METADATA
	...
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_AOWLSpoutSenderManager_AddSender_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(OWLSpoutSenderManager_eventAddSender_Parms, ReturnValue), Z_Construct_UScriptStruct_FOWLSpoutSenderInterface, METADATA_PARAMS(0, nullptr) }; // 506615068
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_AOWLSpoutSenderManager_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_AOWLSpoutSenderManager_ActivateSender, "ActivateSender" }, // 2426486031
		{ &Z_Construct_UFunction_AOWLSpoutSenderManager_AddSender, "AddSender" }, // 2128321331
		{ &Z_Construct_UFunction_AOWLSpoutSenderManager_DeactivateSender, "DeactivateSender" }, // 570774716
		{ &Z_Construct_UFunction_AOWLSpoutSenderManager_RemoveSenderByName, "RemoveSenderByName" }, // 4159487133
	};
	static_assert(UE_ARRAY_COUNT(Z_Construct_UClass_AOWLSpoutSenderManager_Statics::FuncInfo) < 2048);
#if WITH_METADATA
...
#endif
	const UECodeGen_Private::FArrayPropertyParams Z_Construct_UClass_AOWLSpoutSenderManager_Statics::NewProp_SpoutSenders = { "SpoutSenders", nullptr, (EPropertyFlags)0x0010000000000005, UECodeGen_Private::EPropertyGenFlags::Array, RF_Public|RF_Transient|RF_MarkAsNative, nullptr, nullptr, 1, STRUCT_OFFSET(AOWLSpoutSenderManager, SpoutSenders), EArrayPropertyFlags::None, METADATA_PARAMS(UE_ARRAY_COUNT(Z_Construct_UClass_AOWLSpoutSenderManager_Statics::NewProp_SpoutSenders_MetaData), Z_Construct_UClass_AOWLSpoutSenderManager_Statics::NewProp_SpoutSenders_MetaData) }; // 506615068
	...
	const FStructRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLSpout_Public_OWLSpoutSenderManager_h_Statics::ScriptStructInfo[] = {
		{ FOWLSpoutSenderInterface::StaticStruct, Z_Construct_UScriptStruct_FOWLSpoutSenderInterface_Statics::NewStructOps, TEXT("OWLSpoutSenderInterface"), &Z_Registration_Info_UScriptStruct_OWLSpoutSenderInterface, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FOWLSpoutSenderInterface), 506615068U) },
	};
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLSpout_Public_OWLSpoutSenderManager_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_AOWLSpoutSenderManager, AOWLSpoutSenderManager::StaticClass, TEXT("AOWLSpoutSenderManager"), &Z_Registration_Info_UClass_AOWLSpoutSenderManager, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(AOWLSpoutSenderManager), 3759059099U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_toolkit_tmp_Plugins_OWLLivestreamingToolkit_Source_OWLSpout_Public_OWLSpoutSenderManager_h_2891308608(TEXT("/Script/OWLSpout"),
